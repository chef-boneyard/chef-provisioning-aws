...
task :travis, [:sub_task] do |t, args|
  pattern = "load_balancer_spec.rb,machine_spec.rb,aws_iam_instance_profile_spec.rb,aws_security_group_spec.rb,aws_elasticsearch_domain_spec.rb" # This is a comma seperated list
